...
class SendDailyEmail_Misumi1 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:SendDailyEmail_Misumi1';
     ...
     * @var string
     */
    protected $description = 'Send Daily Email Misumi1 Every 16.00 PM';
    ...
    public function handle()
    {
        ...
        $email_bcc  = 'nutnutnutnutnutnutnutnutnutnut@hotmail.com';
        $dir['name'] = 'TEST MAIL';
